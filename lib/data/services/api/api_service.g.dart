...
class _ApiService implements ApiService {
  ...
  Future<LastGate> getLastGate() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LastGate _value;
    try {
      _value = LastGate.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GateInModel> getGateIn() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GateInModel _value;
    try {
      _value = GateInModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<GateLogResult>> searchGateLog(String date, String dateTo) async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<GateLogResult> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => GateLogResult.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<List<GetMemberResponse>> getMemberList() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GetMemberResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/members',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<GetMemberResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                GetMemberResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<VisitorModel> createVisitor(VisitorModel visitor) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VisitorModel _value;
    try {
      _value = VisitorModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<VisitorModel>> listVisitor(String date, String dateTo) async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<VisitorModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => VisitorModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<List<ReportTrafficModel>> reportTraffic(
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<ReportTrafficModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ReportTrafficModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
