...
class VisitorHeaderCard extends StatelessWidget {
  const VisitorHeaderCard({
    required this.selectedColumn, required this.onTapDate, required this.onTapExitTime, required this.onTapPlateNumber, required this.onTapMemberName, super.key,
  });
