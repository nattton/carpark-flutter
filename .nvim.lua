...
require("flutter-tools").setup_project({
	{
		name = "MacOS", -- an arbitrary name that you provide so you can recognise this config
		-- flavor = "Flavor", -- your flavour
		...
		device = "macos", -- the device ID, which you can get by running `flutter devices`
		dart_define = {
			IS_DEV = true,
		},
